...
public class RoomFactory {
	...
	public ArrayList<Door[]> newDoors(){
		Door[] room0Doors = {new Door(rooms.get(1), "north"), new Door(rooms.get(19), "south", true), new Door(rooms.get(11), "east"), new Door(rooms.get(20), "west")};
		...
		Door[] room3Doors = {new Door(rooms.get(4), "north"), new Door(rooms.get(2), "south"), new Door(rooms.get(18), "east"), new Door(null, "west")};
		...
		Door[] room17Doors = {new Door(rooms.get(10), "north"), new Door(null, "south"), new Door(rooms.get(16), "east"), new Door(rooms.get(18), "west")};
